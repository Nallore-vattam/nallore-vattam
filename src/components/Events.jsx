      ...
      <section id="events" className="section events-section">
        <Container>
          <div className="text-center mb-5">
            ...
            <p className={`lead text-muted ${getFontClass()}`}>
              Stay updated with our upcoming community events and activities
            </p>
          </div>
            ...
            {events.map((event) => {
              ...
              return (
                <Col lg={12} key={event.id}>
                  <Card className="event-card-horizontal shadow-sm border-0 h-100">
                    <div className="card-horizontal-content">
                      ...
                      <div className="event-details-section">
                        <div className="event-header">
                          <Card.Title className={`event-title ${getFontClass()} fw-bold`}>
                            {event.title}
                          </Card.Title>
                          <div className="event-meta">
                            <div className="event-info">
                              <i className="bi bi-clock me-2 text-primary"></i>
                              <span className={getFontClass()}>{event.time}</span>
                            </div>
                            <div className="event-info">
                              <i className="bi bi-geo-alt me-2 text-primary"></i>
                              <span className={getFontClass()}>{event.location}</span>
                            </div>
                          </div>
                        </div>
                        <Card.Text className={`event-description ${getFontClass()} text-muted`}>
                          {event.description}
                        </Card.Text>
                      </div>
                      ...
                      <div className="event-actions-section">
                        ...
                        >
                          ...
                          <span className="btn-text">Remind Me</span>
                        </Button>
                      </div>
                    </div>
                  </Card>
